package it.polimi.middleware.kafka.ex2;
...
public class TopicManager  {
    ...
    // BASTA FARLO ESEGUIRE UNA VOLTA PERCHè POI L'IMPOSTAZIONE VIENE SALVATA NEL LOG DEL SERVER DI KAFKA CHE
    // AVNDRà A GESTIRE LE PARTIZIONI
    private static final String defaultTopicName = "topicC1";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Available topics: " + topicsNames + " topicName: "+topicName);
        ...
        if (topicsNames.contains(topicName)) {
            ...
            System.out.println("Topic eliminati: "+delResult.all().get());
            System.out.println("Done!");
            // Wait for the deletion
            Thread.sleep(5000);
        }

        System.out.println("TOPIC DOPO DELETING: "+adminClient.listTopics().names().get());
