...
public class TopicManager  {
    ...
    // INVECE SE VOGLIO AVERE UN SOLO BROKER ALLORA VADO AD UTILIZZARE LE PARTIZIONI
    // POSSO AVERE MULTIPLE CONSUMER NELLO STESSO GRUPPO CHE LEGGONO IN PARALLELO STESSO TOPIC MA IN PARTITIONS DIFFERENTI
    // FARE UN PO' DI ESPERIMENTI
    private static final int defaultTopicPartitions = 2;
    // SE VOGLIO MULTIREPLICA DEVO FAR ANDARE PIù BROKER
